object Penjualan_form: TPenjualan_form
  Left = 228
  Top = 258
  Width = 1128
  Height = 402
  ...
  object dbgrd_penjualan: TDBGrid
    Left = 32
    Top = 200
    Width = 1105
    Height = 153
    DataSource = DataModule1.ds_transaksi
    TabOrder = 0
  ...
  object grp_Laporan: TGroupBox
    ...
    ParentFont = False
    TabOrder = 3
    object tgl_dari: TDateTimePicker
      Left = 16
      Top = 24
      Width = 113
      Height = 26
      Date = 43810.809547175920000000
      Time = 43810.809547175920000000
      TabOrder = 0
    end
  ...
  object rb_lap_tanggal: TRadioButton
    Left = 464
    Top = 80
    Width = 113
    Height = 17
    Caption = 'rb_lap_tanggal'
    TabOrder = 4
